            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="single-page-header-inner">
                        <div class="left-side">
                            <div class="header-image"><a href="single-company-profile.html"><img src="/storage/images/{{ $article->logo }}" alt=""></a></div>
                            <div class="header-details">
                                ...
                                <ul>
                                    ...
                                    <li><img class="flag" src="images/flags/gb.svg" alt="">{{ $article->place }}</li>
                        ...
                        <div class="right-side">
                            <div class="salary-box">
                                ...
                                <div class="salary-amount">$ {{ $article->payment }}</div>
                            </div>
                        </div>
                    </div>
                </div>
...
{{--                </div>--}}
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="sidebar-container">
                    ...
                    <a href="s" class="apply-now-button popup-with-zoom-anim">Apply Now <i class="icon-material-outline-arrow-right-alt"></i></a>
                            ...
                            <div class="job-overview-inner">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <h5>
                                            <?php
                                            $update_at_day =  e($article->updated_at);
