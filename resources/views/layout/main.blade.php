                                ...
                                <ul class="dropdown-nav">
                                    <li><a href="#">Browse Jobs</a>
                                        <ul class="dropdown-nav">
                                            ...
                                            <li><a href="/articles">Full Page Grid</a></li>
...
{{--                            <li><a href="/articles/create1">Add Tag</a></li>--}}
...
{{--                                        <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre style="color: #666;">--}}
{{--                                            {{ Auth::user()->name }}--}}
...
{{--                                <li>--}}
{{--                                    <a class="dropdown-item" href="/home" style="color: #666;">--}}
{{--                                        Кабинет пользовтеля--}}
{{--                                    </a>--}}
{{--                                </li>--}}
{{--                                <li>--}}
{{--                                    <a href="/articles/create">Create Add</a>--}}
{{--                                </li>--}}

{{--                                    <li>--}}
{{--                                        <a class="dropdown-item" style="color: #666;" href="{{ route('logout') }}"--}}
{{--                                                                                           onclick="event.preventDefault();--}}
{{--                                            document.getElementById('logout-form').submit();">--}}
{{--                                            Выйти--}}
{{--                                        </a>--}}
